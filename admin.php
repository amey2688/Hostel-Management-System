...
$query = "select * from seller where location='vellore'";
...
echo '<td bgcolor="#FFFFFF">'.$row['property_name'].'</td>';
echo '<td bgcolor="#FFFFFF">'.$row['Mobile_no'].'</td>';

echo '<td bgcolor="#FFFFFF"><img src="'.$row['Seller_ph1'].'" width="200" height="200"></td>';
echo '</tr>';
echo '<tr>';
echo '<td colspan="4" align="center" bgcolor="#FFFFFF"><input name="delete" type="submit" value="Delete"></td></td>';
echo '</tr>';
