	  ...
	  $con=mysql_connect("localhost","root","");
               ...
               while(($row=mysql_fetch_assoc($result))!=false)
          {
            ...
            echo "<td>";
			 echo "<table>";
			   echo "<tr>";
			     echo "<tr><td>Property name:</td><td><a href='customerview.php?id=".$row['uinque_id']."'>".$row['Address']."</a></td><td rowspan='5'><img src='".$row['Seller_ph1']."' height='200' width='200'></td></tr>";
